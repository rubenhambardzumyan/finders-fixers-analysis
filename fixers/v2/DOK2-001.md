## DOK2 Summary Existence Check Fixer
...
- Synthesize their DOK1 Facts into deeper DOK2 Summaries that show how Facts connect.
- Reveal patterns and relationships that aren't obvious from individual Facts alone.
- Move beyond restating Facts by identifying what emerges when multiple pieces of evidence are viewed together.
- Demonstrate analytical thinking that builds toward their controversial stance.
- Ensure each DOK2 Summary adds interpretive value rather than just reorganizing existing information.

3. Emphasize that DOK2 summaries should show connections between Facts and reveal deeper insights.
