## DOK1 Facts Existence Check Fixer
...
- Identify foundational, verifiable facts that directly support BrainLift's purpose,
- Collect concrete data, research findings, expert articles, or documented evidence,
- Focus on facts that are essential to understanding their domain rather than interesting but tangential information,
- Ensure each fact advances their position or provides critical context for their expertise,
- Emphasize that DOK1 facts build the factual foundation for their argument and must be independently verifiable.
