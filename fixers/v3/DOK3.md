...
2. For each Finder's feedback item, generate a coaching item according to the structure defined in the output.
   ...
   - `lesson` - The lesson about the DOK3 Insights. Do NOT change the lesson from what is provided in this prompt.
...
[
  {
    "dok3_insight": "DOK3 from Finder",
    "coaching_items": [
      {
        "type": "string",
        "lesson": "[BrainLift 200: Deriving DOK3 Insights from Patterns](https://coach.crossover.com/curriculum)",
        "feedback": "DOK3-specific feedback with context",
        "coaching": "Coaching specific to this DOK3 Insight issues"
      }
    ]
  }
]
