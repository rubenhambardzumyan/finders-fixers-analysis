...
2. For each Finder's feedback item, generate a coaching item according to the structure defined in the output.
   ...
   - `lesson` - The lesson about the Knowledge Tree and DOK2 Summaries. Do NOT change the lesson from what is provided in this prompt.
...
[
  {
    "dok2_summary": "DOK2 from Finder",
    "coaching_items": [
      {
        "type": "string",
        "lesson": "[BrainLift 123: Extracting DOK1 Facts and DOK2 Summaries](https://coach.crossover.com/curriculum)",
        "feedback": "DOK2-specific feedback with context",
        "coaching": "Coaching specific to this DOK2 Summary issues"
      }
    ]
  }
]
