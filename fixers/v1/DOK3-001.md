## DOK3 Insights - Existence Check Fixer
...
- Synthesize their DOK2 summaries into original DOK3 Insights.
- Reveal non-obvious patterns, contradictions, or implications not immediately apparent from Facts and Summaries.
- Identify surprising elements that emerge from their knowledge foundation.
- Discover counterintuitive relationships or hidden mechanisms that their analysis reveals.
- Transform analytical thinking into strategic interpretation.
- Create a new understanding that challenges conventional wisdom in their domain.
